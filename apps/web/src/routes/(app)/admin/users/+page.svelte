<script lang="ts">
	...
	const data = $state<UserProfile[]>([
	  ...
	  { id: '2', email: 'user2@example.com', name: 'User Two', role: 'user', image: null, emailVerified: true, banned: true, banReason: 'Posting false content', banExpires: new Date('2023-02-01T00:00:00Z'), createdAt: new Date('2023-02-01T00:00:00Z'), updatedAt: new Date('2023-02-01T00:00:00Z') },
	  { id: '3', email: 'user3@example.com', name: 'User Three', role: 'user', image: null, emailVerified: true, banned: true, banReason: 'Spamming users', banExpires: new Date('2023-03-01T00:00:00Z'), createdAt: new Date('2023-03-01T00:00:00Z'), updatedAt: new Date('2023-03-01T00:00:00Z') },
	  { id: '4', email: 'user4@example.com', name: 'User Four', role: 'user', image: null, emailVerified: true, banned: true, banReason: 'Uploading fake images', banExpires: new Date('2023-04-01T00:00:00Z'), createdAt: new Date('2023-04-01T00:00:00Z'), updatedAt: new Date('2023-04-01T00:00:00Z') },
	  { id: '5', email: 'user5@example.com', name: 'User Five', role: 'user', image: null, emailVerified: true, banned: false, banReason: '', banExpires: new Date('2026-01-01T00:00:00Z'), createdAt: new Date('2023-05-01T00:00:00Z'), updatedAt: new Date('2023-05-01T00:00:00Z') },
	  { id: '6', email: 'user6@example.com', name: 'User Six', role: 'admin', image: '/images/demo-avatar.png', emailVerified: false, banned: false, banReason: '', banExpires: null, createdAt: new Date('2023-06-01T00:00:00Z'), updatedAt: new Date('2023-06-01T00:00:00Z') },
	  { id: '7', email: 'user7@example.com', name: 'User Seven', role: 'user', image: null, emailVerified: false, banned: false, banReason: '', banExpires: null, createdAt: new Date('2023-07-01T00:00:00Z'), updatedAt: new Date('2023-07-01T00:00:00Z') },
	  { id: '8', email: 'user8@example.com', name: 'User Eight', role: 'user', image: null, emailVerified: false, banned: false, banReason: '', banExpires: null, createdAt: new Date('2023-08-01T00:00:00Z'), updatedAt: new Date('2023-08-01T00:00:00Z') },
	  { id: '9', email: 'user9@example.com', name: 'User Nine', role: 'user', image: null, emailVerified: false, banned: false, banReason: '', banExpires: null, createdAt: new Date('2023-09-01T00:00:00Z'), updatedAt: new Date('2023-09-01T00:00:00Z') },
	  { id: '10', email: 'user10@example.com', name: 'User Ten', role: 'user', image: null, emailVerified: false, banned: true, banReason: 'Spamming', banExpires: new Date('2023-10-01T00:00:00Z'), createdAt: new Date('2023-10-01T00:00:00Z'), updatedAt: new Date('2023-10-01T00:00:00Z') },
	  { id: '11', email: 'user11@example.com', name: 'User Eleven', role: 'user', image: null, emailVerified: false, banned: false, banReason: '', banExpires: null, createdAt: new Date('2023-11-01T00:00:00Z'), updatedAt: new Date('2023-11-01T00:00:00Z') },
        ...
        {:else}
            <div class="flex w-full items-center justify-center">
                ...
                {#if error}
                    <small>{error}</small>
                {/if}
                <button onclick={_fetchUsers} class="txt-btn">
                    Re-fetch
                </button>
            </div>
        {/if}
