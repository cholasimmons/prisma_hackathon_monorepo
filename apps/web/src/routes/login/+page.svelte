...
<main
	class="container mx-auto max-w-lg px-8 py-4 dark:text-gray-400 flex flex-col min-h-full w-full items-center justify-start space-y-8"
>
    ...
    >
		...
		<div class="flex items-center justify-between text-sm">
			...
			<a href="/forgot-password" class="dark:text-amber-500 hover:underline">
				Forgot password?
			</a>
		</div>
