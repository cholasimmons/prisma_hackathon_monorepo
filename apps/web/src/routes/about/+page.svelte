...
>
	...
	<div class="flex flex-col items-center justify-center space-y-4 mt-8 text-gray-800 dark:text-gray-200 w-full">
		...
		<img src="/images/Simmons_S_Logo_SM_2025_2.png" alt="Simmons Studio logo" class="w-20 h-20 py-2" />
		<p>
        ...
        <p>
            Please report any bugs or issues to <a href={mono_config.app.email}>{mono_config.credit.author}</a> or <a href={`${mono_config.app.github}/issues`}>GitHub</a>.
